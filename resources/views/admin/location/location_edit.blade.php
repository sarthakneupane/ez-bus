        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <form class="card-body" action="{{ route('admin.location.update', $location->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" class="form-control input-square" id="locationName" value="{{ $location->name }}" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <button type="submit" class="btn btn-outline-success btn-sm w-100">Update</button>
                            </div>
                            <div class="col-md-6">
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="">
                            <label for="locationName">Location Name</label>
                            <h5 id="locationValue">{{ $location->name }}</h5>
                        </div>
                    </div>
                </div>
            </div>
